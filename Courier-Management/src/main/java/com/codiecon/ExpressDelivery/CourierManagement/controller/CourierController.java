...
public class CourierController {
  ...
  public BaseResponse updateStatus(
      @RequestParam("email") String email, @RequestParam("status") CourierStatus status) {
    log.info(" {}", email);
  ...
  public BaseResponse getHubGroup(@RequestParam("email") String email, @RequestParam("otp") String otp) {
